...
import (
	"database/sql"
	dbInfra "github.com/aka-luana/arch-hexagonal/adapters/db"
	"os"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.arch-hexagonal.yaml)")
